...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("foo");
        ...
        config.getMapConfigs().put("com.anjia0532.foo.domain.*", initializeDomainMapConfig(jHipsterProperties));
