...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bar");
        ...
        config.getMapConfigs().put("com.anjia0532.bar.domain.*", initializeDomainMapConfig(jHipsterProperties));
