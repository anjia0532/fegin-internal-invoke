...
@Configuration
public class OAuth2ServiceClientFeignConfiguration {

    private final LoadBalancedResourceDetails loadBalancedResourceDetails;

    public OAuth2ServiceClientFeignConfiguration(LoadBalancedResourceDetails loadBalancedResourceDetails) {
