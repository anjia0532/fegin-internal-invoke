package com.anjia0532.bar.web.rest;

import com.anjia0532.bar.config.DefaultProfileUtil;
import com.anjia0532.bar.web.rest.client.FooFeignClient;
...
public class ProfileInfoResource {
    ...
    public ProfileInfoResource(Environment env, JHipsterProperties jHipsterProperties,FooFeignClient fooFeignClient) {
        this.env = env;
